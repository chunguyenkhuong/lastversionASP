...
<body>
   <form id="form1" runat="server">
    <h1 class="text title"> Create new <b> Student</b></h1>
    <div class="box">
        <div class="container grid">
          <div><asp:Label runat="server" ID="StudentRegisterErrorLabel" ForeColor="IndianRed"></asp:Label></div> 
         <div class="left">
       ...
       <div class="container grid">
            ...
            <div><asp:Hyperlink runat="server" Text="Back" NavigateUrl="~/StudentLogin.aspx" CssClass="text"></asp:Hyperlink></div>
       </div>   
    </div>
