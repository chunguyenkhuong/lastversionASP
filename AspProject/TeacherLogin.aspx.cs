...
namespace AspProject
{
    public partial class TeacherRegister : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            string sql = "SELECT Count(*) FROM Teacher INNER JOIN [User] ON Teacher.user_id = [User].id WHERE [User].username = '" + Username.Text + "' AND password ='" + Password.Text + "'";
            ...
            TeacherLoginErrorLabel.Text = "Username or password is wrong";
            con.Close();
        }
