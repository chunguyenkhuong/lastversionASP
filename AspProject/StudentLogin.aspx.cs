...
namespace AspProject
{
    public partial class StudentLogin : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            string sql = "SELECT Count(*) FROM Student INNER JOIN [User] ON Student.user_id = [User].id WHERE [User].username = '" + Username.Text + "' AND password ='" + Password.Text + "'";
            ...
            StudentLoginErrorLabel.Text = "Username or password is wrong";
            con.Close();
        }
