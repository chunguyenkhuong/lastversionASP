...
<body>
    ...
    <asp:Button runat="server" Text="Back" ID="Back" OnClick="Back_Click" />
        <h1 class="text title"><b>Students'</b> LOG IN</h1>
        <div class="box">
         <div class="container">
            <div><asp:Label runat="server" ForeColor="IndianRed" ID="StudentLoginErrorLabel"></asp:Label></div>
         ...
         <div class="container">
             <div><asp:Hyperlink runat="server" Text="Don't have an account? Register here" NavigateUrl="~/StudentRegister.aspx" CssClass="text"></asp:Hyperlink></div>
